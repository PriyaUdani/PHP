    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/piyuudani">Google Site</a></li>
                    ...
                    <li class="list-group-item"><a href="https://github.com/PriyaUdani/PHP">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
						...
						<div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/PriyaUdani/PHP/tree/main/Task_1">Task 1</a></button>
<button class="sunset-orange-button gradient-button"><a href="https://github.com/PriyaUdani/PHP/tree/main/Task_2">Task 2</a></button>
<button class="spring-green-button gradient-button"><a href="https://github.com/PriyaUdani/PHP/tree/main/Task_3">Task 3</a></button>
<button class="royal-purple-button gradient-button"><a href="https://github.com/PriyaUdani/PHP/tree/main/Task_4">Task 4</a></button>
<button class="ruby-red-button gradient-button"><a href="https://github.com/PriyaUdani/PHP/tree/main/Task_5">Task 5</a></button>
